...
extern "C" __declspec(dllexport) AddonDefinition *GetAddonDef()
{
    ...
    AddonDef.Signature = -918346948;
    AddonDef.APIVersion = NEXUS_API_VERSION;
    AddonDef.Name = "Hover Infos";
    AddonDef.Version.Major = 0;
    AddonDef.Version.Minor = 1;
    AddonDef.Version.Build = 0;
    AddonDef.Version.Revision = 0;
    AddonDef.Author = "Seres67";
    AddonDef.Description = "Displays additional information when hovering over an item";
    AddonDef.Load = Addon::load;
    AddonDef.Unload = Addon::unload;
    AddonDef.Flags = EAddonFlags_None;
    AddonDef.Provider = EUpdateProvider_GitHub;
    AddonDef.UpdateLink = "https://github.com/Seres67/nexus_hover_infos";
